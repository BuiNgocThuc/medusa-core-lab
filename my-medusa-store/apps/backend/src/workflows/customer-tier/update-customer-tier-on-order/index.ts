...
export const updateCustomerTierOnOrderWorkflow = createWorkflow(
    UPDATE_CUSTOMER_TIER_ON_ORDER_ID,
    (input: WorkflowInput) => {
        ...
        // Validate the customer using the validateCustomerStep
        // if the customer is not a registered customer,
        // which will stop the workflow's execution.
