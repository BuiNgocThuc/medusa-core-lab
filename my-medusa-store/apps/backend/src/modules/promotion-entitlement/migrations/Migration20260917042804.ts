...
export class Migration20260917042804 extends Migration {

  override async up(): Promise<void> {
    this.addSql(`alter table if exists "first_purchase_entitlement" drop constraint if exists "first_purchase_entitlement_order_id_unique";`);
    this.addSql(`alter table if exists "first_purchase_entitlement" drop constraint if exists "first_purchase_entitlement_customer_id_unique";`);
