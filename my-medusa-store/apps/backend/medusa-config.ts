                        ...
                        ? [
                              {
                                  ...
                                  options: {
                                      ...
                                      partnerName:
                                          process.env.MOMO_PARTNER_NAME ||
                                          "Medusa Store",
                                      storeId:
                                          process.env.MOMO_STORE_ID ||
                                          "MedusaStore",
                                      redirectUrl:
                                          process.env.MOMO_REDIRECT_URL ||
                                      ...
                                      autoCapture:
                                          process.env.MOMO_AUTO_CAPTURE !==
                                          "false",
                                      lang: (process.env.MOMO_LANG || "vi") as
                                          | "vi"
                                          | "en",
                        ...
                        ? [
                              {
                                  ...
                                  options: {
                                      ...
                                      locale: (process.env.VNPAY_LOCALE ||
                                          "vn") as "vn" | "en",
                                      orderType:
                                          process.env.VNPAY_ORDER_TYPE ||
                                          "other",
                                      paymentExpiryMinutes: Number(
                                          process.env
                                              .VNPAY_PAYMENT_EXPIRY_MINUTES ||
                                              15
                                      ),
                                      refundCreateBy:
                                          process.env
