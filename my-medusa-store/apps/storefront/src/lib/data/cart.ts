...
export async function retrieveCart(cartId?: string, fields?: string) {
    ...
    fields ??=
        '*items, *region, *items.product, *items.variant, *items.thumbnail, *items.metadata, +items.total, +discount_total, +discount_subtotal, *promotions, promotions.application_method.*, +shipping_methods.name'
